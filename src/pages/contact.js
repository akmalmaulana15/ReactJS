...
export default class Contact extends React.Component{
    render(){
        return(
            <div className="bg-green-700 bg">    
                <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
                    <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                        <span className="block font-lg">Customer Service</span>
                        <span className="block text-gray-400 text-base subpixel-antialiased tracking-wide font-medium">Fill in this form and we will contact you within 24 hours .</span>
                        <br/>
                        <hr className=' w-6/12'/>
                    </h2>
                    <div className="mr-32">
                    <form >
                        ...
                        <div class="grid xl:grid-cols-2 xl:gap-6">
                            ...
                            <div class="relative z-0 mb-6 w-full group">
                                ...
                                <label for="floating_company" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Company (don't have to) </label>
                            </div>
                        </div>
